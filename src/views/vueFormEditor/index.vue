					...
					>
						<div class="grid grid-cols-1 gap-4">
							...
							<div class="flex justify-end items-center gap-4">
								<NButton type="primary" @click="downloadJson(jsonData, nameFileJson)">Download</NButton>
...
export default {
	...
	setup() {
		...
		function setExampleJsonData() {
			jsonData.value = EXAMPLE_JSON_DATA
		}
